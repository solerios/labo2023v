...
PARAM  <- list()
PARAM$experimento  <- "ZZ7990cr005"
PARAM$exp_input  <- "HT7510cr005"
...
PARAM$semillerio  <- 5   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
