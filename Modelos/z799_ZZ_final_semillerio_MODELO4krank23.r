...
PARAM  <- list()
PARAM$experimento  <- "ZZ7990_4krank23"
PARAM$exp_input  <- "HT7510_4k"

#Atencion, que cada modelos se procesa con 5 semillas, ajuste a SUS necesidades
PARAM$modelos_rank  <- c( 23 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
